...
@endsection
@section('title','B-Electronics|| Chi tiết sản phẩm')
												...
												<ul class="slides">
													...
													@foreach($photo as $data)
														...
														<li data-thumb="{{$data}}" rel="adjustX:10, adjustY:" >
															{{-- <li data-thumb="{{$data}}" > --}}
															<img src="{{$data}}" alt="{{$data}}" data-zoom-image="{{$data}}" id="img"  >
														</li>
											...
											<div class="product-buy">
												<form action="{{route('single-add-to-cart')}}" method="POST">
													...
													<div class="add-to-cart mt-4">
														...
														<a href="{{route('add-to-wishlist',$product_detail->slug)}}" class="btn min" style="color:red; background-color:pink"><i class="ti-heart"></i></a>
													</div>
												</form>
														...
														<div class="row">
															<div class="col-12">
																<div class="single-des">
																	...
																	https://stackoverflow.com/questions/35030977/what-is-the-difference-between-and-in-laravel-blade-files
																	Lấy các description trong product_detail in ra HTML  --}}
															...
															<div class="col-12">
																...
																<div class="comment-review">
																	<div class="add-review">
																		<h5>Thêm đánh giá</h5>
																		<p>Email của bạn sẽ không được công khai. Vui lòng đánh sao xếp hạng</p>
																	</div>
                                                                            ...
                                                                            <div class="rating_box">
                                                                                  <div class="star-rating">
                                                                                    <div class="star-rating__wrap">
																						{{-- Khi click thì value được gán cho name --}}
