 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
              ...
              @endphp
                <tr>
                    ...
                    <form method="POST" action="{{route('product.destroy',[$product->id])}}">
                      @csrf 
                      @method('delete')
                          <button class="btn btn-danger btn-sm dltBtn" data-id={{$product->id}} style="height:30px; width:30px;border-radius:50%; margin-top:10px" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-trash-alt"></i></button>
                        </form>
                    </td>
                    {{-- Delete Modal --}}
        ...
        @else
          <h6 class="text-center">Không còn sản phẩm, vui lòng thêm mới!</h6>
        @endif
      </div>
    </div>
</div>
