                    ...
                    @if($cat->is_parent==1)
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="single-banner">
                                ...
                                <div class="content">
                                    <h3>{{$cat->title}}</h3>
                                      <a  href="{{route('product-cat',$cat->slug)}}">Chi tiết</a>
                                </div>
                            </div>
                        </div>
                    @endif
                    ...
                    @foreach($product_lists as $product)
                        <div class="col-md-4">
                            ...
                            <div class="single-list">
                                ...
                                <div class="col-lg-6 col-md-12 col-12 no-padding">
                                    <div class="content">
                                        ...
                                        <p class="price with-discount" id="new-price">New</p>
                ...
                @foreach($featured as $data)
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="single-banner">
                            ...
                            <div class="content">
                            {{-- Peter fixed here --}}
                                <div id="discount-flash">
                                <p>{{$data->cat_info['title']}}</p>
                                <h3>{{$data->title}} <br>Up to<span> {{$data->discount}}%</span></h3>
                                 </div>
                            </div>
                            <div > <a href="{{route('product-detail',$data->slug)}}">Mua  ngay</a> </div>
                        </div>
                    </div>
                    <!-- /End Single Banner  -->
                @endforeach
