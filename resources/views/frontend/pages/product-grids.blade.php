...
@section('title','B-Electronics||Trang sản phẩm')
                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="shop-sidebar">
                                ...
                                <div class="single-widget recent-post">
                                    <h3 class="title">Sản phẩm mua nhiều</h3>
                                    {{-- {{dd($recent_products)}} --}}
                                    ...
                                    <div class="shop-shorter">
                                        ...
                                        <div class="single-shorter">
                                            ...
                                            <select class='sortBy' name='sortBy' onchange="this.form.submit();">
                                                ...
                                                <option value="price" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='price') selected @endif>Giá cả</option>
                                                <option value="category" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='category') selected @endif>Hạng mục</option>
