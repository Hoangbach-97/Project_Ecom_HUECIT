                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Danh sách project</a></li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group  comment_form_body">
                                                        <label>Hãy để lại bình luận<span>*</span></label>
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget category">
                            <h3 class="title">Danh mục project</h3>
                        ...
                        <div class="single-widget recent-post">
                            <h3 class="title">Project gần đây</h3>
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                <h6>Đăng kí để nhận sản phẩm mới nhất.</h6><br/>
