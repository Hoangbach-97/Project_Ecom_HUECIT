								...
								@else 
										<tr>
											<td class="text-center">
												Bạn không có sản phẩm nào trong giỏ hàng. <a href="{{route('product-grids')}}" style="color:blue;">Tiếp tục mua sắm</a>
					...
					<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Tổng giá sản phẩm<span>{{number_format(Helper::totalCartPrice())}}đ</span></li>
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Thanh toán<span>{{number_format($total_amount)}}đ</span></li>
										@else
											<li class="last" id="order_total_price">Thanh toán<span>{{number_format($total_amount)}}đ</span></li>
										@endif
									</ul>
	...
	<script>
		$(document).ready(function(){
			$('.shipping select[name=shipping]').change(function(){
				...
				// alert(coupon);
				$('#order_total_price span').text('$'+(subtotal + cost-coupon));
			});
