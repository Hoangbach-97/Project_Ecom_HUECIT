            ...
            @if(count($orders)>0)
              @foreach($orders as $order)   
                <tr>
                    ...
                    <td>
                      <a href="{{route('user.order.show',$order->id)}}" class="btn btn-success btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="view" data-placement="bottom"><i class="fas fa-eye"></i></a>
                      <a href="{{route('qrcode',$order->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="qrcode" data-placement="bottom"><i class="fas fa-qrcode"></i></a>
              ...
              @endforeach
              @else
                <td colspan="8" class="text-center"><h4 class="my-4">Bạn không có đơn hàng nào!</h4></td>
              @endif
          </tbody>
        </table>
