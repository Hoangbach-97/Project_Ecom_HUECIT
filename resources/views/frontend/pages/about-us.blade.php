...
@section('title','B-Electronics|| Giới thiệu')
				...
				<div class="row">
					<div class="col-lg-6 col-12">
						<div class="about-content">
							...
							@endphp
							<h3>Chào mừng đến với<span>B-Electronics</span></h3>
							<p>@foreach($settings as $data) {{$data->description}} @endforeach</p>
							<div class="button">
								<a href="{{route('blog')}}" class="btn">Project mẫu</a>
								<a href="{{route('contact')}}" class="btn primary">Liên lạc</a>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-12">
